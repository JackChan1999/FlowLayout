...
public class FlowLayout62 extends ViewGroup
{
	private List<Line>	mLines				= new ArrayList<FlowLayout62.Line>(); // 用来记录描述有多少行View
	private Line		mCurrrenLine;						      // 用来记录当前已经添加到了哪一行
	private int			mHorizontalSpace	= 10;
	private int			mVerticalSpace		= 10;

	public FlowLayout62(Context context, AttributeSet attrs) {
		super(context, attrs);
	}

	public FlowLayout62(Context context) {
		super(context);
	}
