 ...
 * ============================================================
 **/
public class FlowLayout56 extends ViewGroup
{
	private List<Line>	mLines				= new ArrayList<FlowLayout56.Line>(); // 用来记录描述有多少行View
	private Line		mCurrrenLine;							  // 用来记录当前已经添加到了哪一行
	private int			mHorizontalSpace	= 10;
	private int			mVerticalSpace		= 10;

	public FlowLayout56(Context context, AttributeSet attrs) {
		super(context, attrs);
	}

	public FlowLayout56(Context context) {
		super(context);
	}
